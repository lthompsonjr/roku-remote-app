...
public class UDPSocketConnection : SocketConnectionProtocol, GCDAsyncUdpSocketDelegate
{
    ...
    func openConnection<T>() -> T
    {
        ...
        mySocket.bindToPort(broadcastPort)
        mySocket.joinMulticastGroup(broadcastAddress)
        mySocket.beginReceiving()
    }

    
    func closeConnection<T>() -> T
    {
